...
public class CarService {
   ...
   /* public CarService(CarRepository repository) {
    ...
    public Car findById(Long id) {
         ...
         */
        String price = pricing.get().uri("/pricing-service/price/{id}",id).retrieve().toString();
        car.setPrice(price);
        /**
        ...
        String adres = maps.get().uri("/maps?lat={lat}&lon={lon}",id).retrieve().toString();
        loc.setAddress(adres);
        car.setLocation(loc);
